...
ドキュメントスキャンは[NFC.cool Tools for iPhone](https://apps.apple.com/app/apple-store/id1249686798?pt=106913804&ct=blog_document-scanning-guide_ja&mt=8)の機能です（Android版はNFCに集中しています。ドキュメントスキャナーはAppleのVisionフレームワークが必要です）。
