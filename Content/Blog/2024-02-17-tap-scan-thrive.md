...
metaDescription: "QR codes can encode Wi-Fi credentials, contacts, calendar events, locations and more - not just URLs. A practical guide to every QR payload type and when to use it."
