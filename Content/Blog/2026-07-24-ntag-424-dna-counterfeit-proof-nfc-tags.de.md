...
imageAlt: "Eine Ledertasche mit einem NFC-Echtheitsanhänger neben einem iPhone, das ein Sicherheitsschild und Schlüsselsymbole zeigt"
...
Vor einiger Zeit ist mir immer wieder dieselbe Behauptung untergekommen: Luxusmarken bauen NFC-Chips in ihre Produkte, damit du dein Handy an eine Tasche oder ein Paar Sneaker halten und wissen kannst, dass es das Original ist und keine Fälschung. Jeder Artikel brachte denselben glänzenden Satz, und keiner sagte, *wie*. Was hält einen Fälscher eigentlich davon ab, den Chip gleich mit der Handtasche zu kopieren?

Also habe ich das getan, was ich immer tue, wenn mich ein Tag neugierig macht. Ich bin auf AliExpress gegangen, habe ein Angebot für „NTAG 424 DNA“ Tags gefunden, einen kleinen Schwung bestellt und darauf gewartet, dass der Umschlag auftaucht. Ein paar Euro, ein paar Wochen, und ich hatte dasselbe Silizium, auf dem diese Markenschutz-Systeme aufbauen, auf meinem Schreibtisch liegen. Dann habe ich einen gescannt, um zu sehen, was er tut.
...
Die sanfte Variante besteht aus drei Schritten. Schreib deinen eigenen Link, das ist kostenlos. Schalte SUN ein, damit der Tag anfängt, jeden Tap zu signieren. Und ersetze den Werksschlüssel durch deinen eigenen, festgelegt als Passphrase, damit du dich nicht mit einer 32-stelligen Hex-Zeichenkette herumschlagen musst, gespeichert in deinem Schlüsselbund. Ab diesem Punkt ist der Tag an dich gebunden: Er beweist weiterhin jedem, der ihn scannt, dass er echt ist, aber nur du kannst ihn je neu programmieren.
