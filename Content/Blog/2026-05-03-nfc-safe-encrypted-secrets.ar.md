...
بحكم عملي على NFC كل يوم، رأيتُ هذه الوسوم تتحوّل بهدوء إلى وسيط تخزين للأشياء المهمة. ويُدرج جواز المنتج الرقمي في الاتحاد الأوروبي تقنية NFC ضمن حوامل البيانات المعتمدة لديه، جنبًا إلى جنب مع رموز QR. وتضعها Philips في رؤوس فرش الأسنان. وتستخدمها الفنادق لمفاتيح الغرف. رخيصة، ومعمّرة، وقابلة للقراءة عالميًا بالجهاز الموجود أصلًا في جيبك - هذا المزيج نادر، وهو تحديدًا سبب استمراري في اكتشاف استخدامات جديدة لها. إذا أردتَ نظرة أوسع، فقد غطّيتُ الأساسيات في [شرح وسوم NFC: دليل كامل للمبتدئين](/blog/nfc-tags-beginners-guide/).
