...
[空白のNFCタグ](/ja/affiliate-links/)はオンラインで1枚**€0.30〜€1.00**程度で購入できます。いくつかの形状があります。
...
ほとんどのプロジェクトには、**NTAG216**がベストな選択です - 888バイトの使用可能メモリ、幅広い互換性、まとめ買いなら手頃な価格。NFC.cool自身が[推奨し、テストにも使っているチップ](/ja/affiliate-links/)です。簡単にまとめると：
...
パワフルで使いやすいNFC書き込みアプリをお探しなら、**[NFC.cool Tools](https://apps.apple.com/app/apple-store/id1249686798?pt=106913804&ct=blog-write-nfc-tags-iphone-ja&mt=8)**が基本的なURL書き込みから高度なタグ管理まで、iOSショートカット連携によるオートメーション機能を含めて、すべてに対応しています。
