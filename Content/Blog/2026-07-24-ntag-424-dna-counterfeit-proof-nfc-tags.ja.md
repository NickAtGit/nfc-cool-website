...
少し前から、同じ主張を何度も目にするようになりました。高級ブランドが製品にNFCチップを仕込んでいて、バッグやボトルにスマホをかざせば、それが偽物ではなく本物だとわかる、というものです。どの記事も同じ耳ざわりのいい一文を並べるだけで、*どうやって*なのかを語るものは一つもありませんでした。偽造業者がハンドバッグごとチップをコピーするのを、実際に何が食い止めているのでしょうか。
