...
<details class="faq-item">
<summary>iOSとAndroidの違いは？</summary>
...
<p>ルームスキャンにはAppleのLiDARセンサーが必要です - iPhone 12 Pro以降のProモデル、およびiPad Pro 2020以降が対象です。フォトグラメトリベースの3Dオブジェクト・スキャンは、iOS 17に対応し十分な処理能力を持つ任意のiPhone(おおむね2020年以降のモデル)で動作します。</p>
</details>
...
<p>LiDAR搭載のiPad ProではiPhone版アプリが動作し、3D・ルームスキャンのフル機能を利用できます。現時点でMacやApple Watch専用アプリはありませんが、Business CardのAppClipはContinuity経由でApple WatchとMacの両方で動作します。</p>
</details>
...
<details class="faq-item">
<summary>企業でもNFC.coolを利用できますか？</summary>
<p>はい - Webhookを使えば、チームのバックエンドやCRM、自動化ツール(Zapier、n8n、Make)へNFCやQRのスキャンを直接送信できます。NFC.coolのアカウントもアップロードも不要で、データがNFC.coolのサーバーを通ることはありません。大規模なNFCタグ・キャンペーンやカスタムブランディングのご相談は<a href="mailto:info@nfc.cool?subject=NFC.cool%20Support">メールでお問い合わせください</a>。</p>
</details>
...
<p>返金はAppleまたはGoogleが直接対応しており、NFC.coolでは処理しません。iOS: 設定 → App Store → 名前をタップ → 購入履歴。Android: Google Play → アカウント → 注文履歴。</p>
</details>

<details class="faq-item">
<summary>機能を提案したいのですが。</summary>
<p>ぜひ - <a href="mailto:info@nfc.cool?subject=NFC.cool%20Support">メールでご連絡ください</a>。すべてのご提案を記録し、ロードマップに反映します。</p>
</details>

<details class="faq-item">
<summary>ビジネス / チームプランはありますか？</summary>
<p>Webhookでほとんどのチームワークフローはカバーできるため、特別なプランは不要です。大規模な展開(NFCタグキャンペーン、カスタムブランディング、一括書き込みツール)は<a href="mailto:info@nfc.cool?subject=NFC.cool%20Support">メールでお問い合わせください</a>。</p>
</details>

<details class="faq-item">
<summary>プライバシーに関する懸念を報告したい。</summary>
<p><a href="mailto:info@nfc.cool?subject=NFC.cool%20Support">メールでご連絡ください</a>。プライバシー関連のお問い合わせには5営業日以内に返信します。</p>
</details>
