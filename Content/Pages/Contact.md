...
slug: "contact"
description: "Reach NFC.cool - email support, frequently asked questions, the developer's direct line for partnership and integration enquiries, and social channels."
---
...
<p>For iPhone, NTAG-series Type 2 tags (NTAG213/215/216) work best. NFC.cool supports the full NFC Forum spec (Types 1-5) including MIFARE Classic, MIFARE Ultralight, MIFARE DESFire, ISO 14443, ISO 15693, and FeliCa. Avoid extremely cheap stickers - antenna quality matters.</p>
</details>
...
<p>By default, everything stays on your device - scans, written tags, contacts, documents, 3D models. Nothing is uploaded to NFC.cool. You can opt in to webhooks if you want to forward scan data to your own server; even then NFC.cool never sees the data.</p>
</details>

<details class="faq-item">
<summary>Is it GDPR-compliant?</summary>
<p>The apps process data on-device, so there's no transfer of personal data to NFC.cool in the default mode. The website itself is cookie-free. The newsletter (Mailjet) is the only third-party data flow, and the form is self-hosted so no cookies are set on visit. See the <a href="/privacy/">Privacy policy</a> for the full breakdown.</p>
</details>
