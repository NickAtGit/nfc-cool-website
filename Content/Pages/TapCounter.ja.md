...
<p class="tap-demo-kicker">タグをスキャン</p>
<div class="tap-demo-count-row">
<p class="tap-demo-count" data-tap-count>0</p>
<p class="tap-demo-count-caption">回のスキャン、タグ自身が集計</p>
</div>
<div class="tap-demo-id-row">
<span class="tap-demo-id-label">タグID</span>
<code class="tap-demo-id-value" data-tap-id></code>
</div>
<p class="tap-demo-raw">デコード元: <code data-tap-raw></code></p>
</div>
<div class="tap-demo-card tap-demo-empty">
<p class="tap-demo-kicker">ライブデモ</p>
<p class="tap-demo-empty-text">ここを指すNFCタグをタップすると、そのスキャン回数がこのカードに表示されます。</p>
<p class="tap-demo-empty-hint">タグの宛先</p>
<p class="tap-demo-url"><code>https://nfc.cool/ja/tap-counter/</code></p>
</div>
</div>
...
どのチップが使えるか、手順ごとの設定など、詳しい内容を知りたいですか。[サーバーなしでNFCタグのスキャン回数を数える方法](/ja/blog/count-nfc-tag-scans/)を読むか、[NFCリーダー＆ライター機能](/ja/features/nfc-reader-writer/)の全体をご覧ください。
